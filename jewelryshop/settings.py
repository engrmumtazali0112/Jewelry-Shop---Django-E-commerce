...
# Contact Email (for receiving form submissions)
CONTACT_EMAIL = 'engrmumtazali01@gmail.com'  # Add closing quote
...
# Add these settings at the appropriate sections of your settings.py
